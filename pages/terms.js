const Terms = () => {
    return (
        <div className="bg-bgColor text-white px-28">
            <h1 className="text-3xl font-bold py-16">Terms of Service</h1>
            <p className="pb-8">
            These Terms of Service constitute an agreement (this “Agreement”) for the provision of Cloud Services by Metricks Inc. and any person or entity opening an online account with Metricks Inc (“Customer”) as specified in the information provided by Customer to Metricks in the online registration form. These Terms and Conditions ("Terms", "Terms and Conditions") govern your relationship with Metricks website (the "Service") operated by Metricks Inc ("us", "we", or "our").
            </p>
            <div className="flex">
            <p className="border-l-8 pr-4"></p>
            <p>
            This Agreement is effective as of the date Customer clicks “Accepted and Agreed To” or a similar button in the process of opening an online account with Metricks Inc (the “Effective Date”). Customer’s use of and Metricks provision of the Cloud Services and Metricks System (each as defined below) are governed by this Agreement.
            </p>
            </div>

            <h1 className="text-3xl font-bold pt-16 pb-4">1. Website Terms and Conditions of Use</h1>
            <p>
